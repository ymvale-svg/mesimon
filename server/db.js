...
const DEFAULT_SETTINGS = {
  ...
  signup_token: '',
  /*
   * צ'קליסט מלא סוגר את המשימה. דלוק כברירת מחדל — זו ההתנהגות המבוקשת,
   * וההגדרה קיימת בשביל צוות שמשתמש בצ'קליסט כרשימת מעקב במשימה ארוכה
   * שאינה נגמרת כשהרשימה נגמרת.
   */
