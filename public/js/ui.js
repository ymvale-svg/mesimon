...
const UI = (() => {
  ...
  /*
   * חמש שניות. שלוש לא הספיקו לקרוא כותב, כותרת ושם משימה בכרטיס אחד —
   * ובמיוחד כשמגיעים שלושה כרטיסים יחד. השעון נעצר כשהעכבר על הכרטיס
   * ונדרך מחדש ביציאה, ולכן ההארכה אינה מאריכה את החשיפה למי שקרא וסיים.
   */
  const POP_MS = 5000;
